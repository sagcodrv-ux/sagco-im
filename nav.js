...
function printCurrentPage() {
  ...
  if (!document.getElementById(styleId)) {
    ...
    s.textContent = [
      ...
      '#sidebar,#tb,.back-row,.pp-back,.pp-print-btn,.topbar-btn,.no-print,button,#se-bar,#se-toggle,#se-dismiss,#se-fmt,#se-toast,#se-restore-btn,.se-img-ov,#edit-mode-bar,.edit-mode-bar,[id^="se-"],[class^="se-"],[id*="edit-mode"],[class*="edit-mode"] { display:none!important; }',
